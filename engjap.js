...
const translations = {
  en: {
    ...
    confirmEndRounds: "End session and go to Summary?",
  ...
  vi: {
    ...
    confirmEndRounds: "Kết thúc phiên và xem kết quả?",
