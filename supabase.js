...
const alreadyLinked = await sbGet(“club_members”,
`club_id=eq.${club.id}&player_id=eq.${existing[0].id}`);
if (alreadyLinked.length) throw new Error(“Player already exists in this club.”);
player = existing[0];
} else {
